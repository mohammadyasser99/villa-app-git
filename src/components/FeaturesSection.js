...
import featured from '../images/featured-icon.png'
import icon1 from '../images/info-icon-01.png'
import icon2 from '../images/info-icon-02.png'
import icon3 from '../images/info-icon-03.png'
import icon4 from '../images/info-icon-04.png'
            ...
            <div class="col-lg-4">
              <div class="left-image">
                ...
                <a href="property-details.html">
                    <img src={featured} alt="" style={{maxWidth :"52px" , padding :"0px"}} />
                    </a>
              </div>
            </div>
            <div class="col-lg-5">
